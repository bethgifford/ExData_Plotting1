...
png(file="./Plots/plot4.png",  width = 480, height = 480, units="px")
  par(mfrow=c(2,2))
  plot(energy2$Global_active_power ~ energy2$DateTime, type="l", xlab="", ylab="Global Active Power")
  plot(energy2$Voltage ~ energy2$DateTime, type="l", xlab="datetime", ylab="")
  ...
  plot(energy2$Global_reactive_power ~ energy2$DateTime, type="l", xlab="datetime", ylab="")
dev.off()
